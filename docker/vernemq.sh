...
#fi
#
if [ -n "$DOCKER_VERNEMQ_DISTRIBUTED_COOKIE" ]; then
    echo "-setcookie ${DOCKER_VERNEMQ_DISTRIBUTED_COOKIE}" >> /vernemq/etc/vm.args
else
...
EOF
    ...
    echo "distributed_cookie = ${DOCKER_VERNEMQ_DISTRIBUTED_COOKIE}"
